...
.sc-danger { border-top: 3px solid var(--danger) !important; }
...
.count-badge {
    ...
    border-radius: 20px; background: var(--danger-light);
...
<div class="container-fluid px-3 py-2">
    ...
    <div class="page-top">
        <div class="page-top-left">
            <h4><i class="dw dw-cancel mr-2" style="color:var(--danger)"></i>Pengajuan Ditolak</h4>
            <p>Daftar pengajuan KPR yang ditolak (oleh marketing atau sistem)</p>
        </div>
    ...
    <div class="card mb-4">
        <div class="filter-bar">
            <form method="GET" action="{{ route('marketing.pengajuan.ditolak') }}">
                <div class="row align-items-end" style="row-gap:12px">
                    ...
                    <div class="col-md-2">
                        <div class="d-flex" style="gap:8px">
                            ...
                            <a href="{{ route('marketing.pengajuan.ditolak') }}" class="btn-filter reset">
    ...
    <div class="row mb-4" style="row-gap:14px">
        <div class="col-md-4">
            <div class="card stat-card sc-danger">
                <div class="stat-top">
                    <div>
                        <p class="stat-label mb-1">Total Ditolak</p>
                ...
                <p class="stat-sub"><i class="dw dw-analytics mr-1"></i> Pengajuan yang ditolak</p>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card stat-card">
                <div class="stat-top">
                    <div>
                        <p class="stat-label mb-1">Ditolak Marketing</p>
                        <div class="stat-value sm">{{ $ditolakMarketing ?? 0 }}</div>
                    </div>
                    <div class="stat-icon icon-warning">
                        <i class="dw dw-user"></i>
                    </div>
                </div>
                <p class="stat-sub"><i class="dw dw-flag mr-1"></i> Ditolak oleh marketing</p>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card stat-card">
                <div class="stat-top">
                    <div>
                        <p class="stat-label mb-1">Ditolak Sistem</p>
                        <div class="stat-value sm">{{ $ditolakSistem ?? 0 }}</div>
                    </div>
                    <div class="stat-icon icon-info">
                        <i class="dw dw-android"></i>
                    </div>
                </div>
                <p class="stat-sub"><i class="dw dw-robot mr-1"></i> Ditolak oleh sistem SMART</p>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h6 class="card-title">
                <i class="dw dw-cancel" style="color:var(--danger)"></i>
                ...
                <table class="table aq-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th style="width:14%">Plafon KPR</th>
                            <th style="width:10%">Tgl Ditolak</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong style="color:var(--danger)">{{ $item->kode_pengajuan }}</strong>
                        ...
                        <td>
                            <div style="font-weight:700;font-size:.82rem;color:var(--danger)">
                                {{ App\Helpers\MarketingHelper::formatRupiah($item->jumlah_pinjaman) }}
                            </div>
                            <span style="font-size:.7rem;color:var(--muted)">{{ $item->tenor_tahun }} Tahun</span>
                        </td>
                        <td>
                        ...
                        <td>
                            @if($item->status == 'ditolak_marketing')
                                <span class="badge badge-danger" style="background:var(--danger-light);color:var(--danger);padding:5px 10px;border-radius:20px">
                                    <i class="dw dw-user"></i> Ditolak Marketing
                                </span>
                            @else
                                <span class="badge" style="background:var(--warning-light);color:var(--warning);padding:5px 10px;border-radius:20px">
                                    <i class="dw dw-android"></i> Ditolak Sistem
                                </span>
                            @endif
                        </td>
                        <td>
                        ...
                        <tr>
                            <td colspan="8">
                                <div class="empty-state">
                                    <i class="dw dw-cancel"></i>
                                    <h6>Tidak ada pengajuan yang ditolak</h6>
                                    <p>Semua pengajuan dalam proses atau disetujui</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
