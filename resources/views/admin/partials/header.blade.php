                    ...
                    <div class="notification-list mx-h-350 customscroll">
                        <ul>
                            @forelse(($notifications ?? collect()) as $notification)
                                <li>
                                    <a href="{{ $notification->pengajuan_id ? route('admin.pengajuan.show', $notification->pengajuan_id) : '#' }}">
        ...
        <div class="user-info-dropdown">
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                    ...
                    <span class="user-name">{{ Auth::check() ? Auth::user()->nama_lengkap : 'Administrator' }}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                    <a class="dropdown-item" href="#"><i class="dw dw-user1"></i> Profil</a>
                    <a class="dropdown-item" href="{{ route('admin.pengaturan.index') }}"><i class="dw dw-settings2"></i> Pengaturan</a>
